...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.3-RC.153/TruvideoSdk.xcframework.zip",
            checksum: "aa083e50df53fc86043061ee4da6d69a61a63e95ac11fbf0fe8965553720ec37"
        ),
        .binaryTarget(
            name: "Common",
