...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.218/TruvideoSdk.xcframework.zip",
            checksum: "d6ce5057144633d9f5bc50612405f409bd4dc860c9f01f34f941f74c54d35635"
        ),
        .binaryTarget(
            name: "Common",
