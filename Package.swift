...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/68.1.1-beta.100/TruvideoSdk.xcframework.zip",
            checksum: "4da310b7144bd4b726bde69172b462c3c509f78254c2fcca5cfcfa1a681da6b2"
        ),
        .binaryTarget(
            name: "Common",
