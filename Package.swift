...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/0.1.2-beta.88/TruvideoSdk.xcframework.zip",
            checksum: "a6fa9ae14eaac85dfe1163ebb5614092703652d29a4e8a3221d75457dfbae740"
        ),
        .binaryTarget(
            name: "Common",
