...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-BETA.225/TruvideoSdk.xcframework.zip",
            checksum: "1fdb33bc5ea4ab5bfb4303269c7ff9de46b40d0a13c99912dda47c868a06855b"
        ),
        .binaryTarget(
            name: "Common",
