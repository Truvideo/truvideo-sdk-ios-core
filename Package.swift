...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-BETA.229/TruvideoSdk.xcframework.zip",
            checksum: "bfc65e5bfd157bcd8546986a537b26f2055987205cf3ccf2e50011c3c26a3824"
        ),
        .binaryTarget(
            name: "Common",
