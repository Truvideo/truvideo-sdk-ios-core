...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.220/TruvideoSdk.xcframework.zip",
            checksum: "029ac9bf645567bf44f4d7bc976c43409f3b4fa56e5982beff66546c6ae1e29e"
        ),
        .binaryTarget(
            name: "Common",
