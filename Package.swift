...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.2-BETA.123/TruvideoSdk.xcframework.zip",
            checksum: "50de7f162a5d6551df1d1a914e70f5c7ad6ca94e980706b99572df59415566da"
        ),
        .binaryTarget(
            name: "Common",
