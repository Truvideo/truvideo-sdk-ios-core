...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.1-RC.152/TruvideoSdk.xcframework.zip",
            checksum: "66360020b21e2ebbe55a6e845eccdbe11d02288ea4230db953b380a1edcbe44e"
        ),
        .binaryTarget(
            name: "Common",
