...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-BETA.239/TruvideoSdk.xcframework.zip",
            checksum: "1794a3106bd376b8e3a11817b425891e03f98c590c891bf068827845edb7d8f6"
        ),
        .binaryTarget(
            name: "Common",
