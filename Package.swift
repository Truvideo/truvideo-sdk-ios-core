...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.2-BETA.112/TruvideoSdk.xcframework.zip",
            checksum: "62a1a87f6435062c8f7d90bdae573a56bb83cf683c48173577cfe0074ab6644f"
        ),
        .binaryTarget(
            name: "Common",
