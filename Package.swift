...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.2-DEV.109/TruvideoSdk.xcframework.zip",
            checksum: "b57fcbefd232c01163959f28931d517cecd2ed79f090366c9569683550a4b1d5"
        ),
        .binaryTarget(
            name: "Common",
