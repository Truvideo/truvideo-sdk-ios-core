...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-BETA.164/TruvideoSdk.xcframework.zip",
            checksum: "cd834d6dea0c0b3b6327694d4d88934f9b13c76aeb963fc80b881333c2c85eca"
        ),
        .binaryTarget(
            name: "Common",
