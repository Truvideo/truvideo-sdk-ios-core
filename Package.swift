...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.2.2-RC.9/TruvideoSdk.xcframework.zip",
            checksum: "df39df193bca6ad79c89ebfb623826cbd590d50a08e0b80321079c22e4bb972f"
        ),
        .binaryTarget(
            name: "Common",
