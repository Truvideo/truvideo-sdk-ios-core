...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.1-DEV.151/TruvideoSdk.xcframework.zip",
            checksum: "92a2f61a16189d62548838691665626b27ce483ae83f5449099dbea8bb889d9e"
        ),
        .binaryTarget(
            name: "Common",
