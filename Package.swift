...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-BETA.211/TruvideoSdk.xcframework.zip",
            checksum: "d72fee2695e2726628e49d83e08868d90a3a95f1930ceff040463ea171369a6a"
        ),
        .binaryTarget(
            name: "Common",
