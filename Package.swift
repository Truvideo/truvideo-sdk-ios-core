...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-BETA.227/TruvideoSdk.xcframework.zip",
            checksum: "a02d7b52f21e00cc262344841f0b0f614d3b1cc337189c03a1a0021d2e0b76c4"
        ),
        .binaryTarget(
            name: "Common",
