...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.163/TruvideoSdk.xcframework.zip",
            checksum: "e605f4e664590365dfb04527aa12ec0dec43a648d2ba17cf63ddec2e3190a710"
        ),
        .binaryTarget(
            name: "Common",
