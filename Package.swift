...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.217/TruvideoSdk.xcframework.zip",
            checksum: "bc13c016dc4b84daac66a093a18bf3be8e6925e8b2d9f14a211f3343fe00ed3f"
        ),
        .binaryTarget(
            name: "Common",
