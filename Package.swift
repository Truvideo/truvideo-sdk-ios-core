...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.219/TruvideoSdk.xcframework.zip",
            checksum: "bf1efdeeb9fb7b95459248008861dc8ed2a33bba47aeae692152673f33c215e2"
        ),
        .binaryTarget(
            name: "Common",
