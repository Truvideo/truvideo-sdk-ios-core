...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.1/TruvideoSdk.xcframework.zip",
            checksum: "00eac04a054ab89d57549d48cf287bfc45ce8d9051398ee99bfc182194afe77d"
        ),
        .binaryTarget(
            name: "Common",
