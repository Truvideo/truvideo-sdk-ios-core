...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.1-BETA.106/TruvideoSdk.xcframework.zip",
            checksum: "9789c3118727fe5f9db319055be45e00c984e9c50c53ab18069b8781b29fc765"
        ),
        .binaryTarget(
            name: "Common",
