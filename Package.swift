...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-BETA.160/TruvideoSdk.xcframework.zip",
            checksum: "bc60a1a82263f4eee6af353a0b5969fe96aad25dc0330c96a35ca1c6ee0197c5"
        ),
        .binaryTarget(
            name: "Common",
