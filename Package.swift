...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-RC.162/TruvideoSdk.xcframework.zip",
            checksum: "a91beea7eee2f528a596d508060621e8cc582816098a26d0b2d9ef82c40cf929"
        ),
        .binaryTarget(
            name: "Common",
