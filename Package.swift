...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.2-BETA.119/TruvideoSdk.xcframework.zip",
            checksum: "c4fe5432e5eea410d67c9333cd9bea70d1388b04ba205b7b01efa6a1802bd0c4"
        ),
        .binaryTarget(
            name: "Common",
