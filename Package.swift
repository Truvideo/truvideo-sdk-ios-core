...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.215/TruvideoSdk.xcframework.zip",
            checksum: "107e6c8e6c91e622953e0ba6701bf698d2a6727ebb08ccc6b09e0f6a27886d2b"
        ),
        .binaryTarget(
            name: "Common",
