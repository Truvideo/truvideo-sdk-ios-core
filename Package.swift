...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-BETA.214/TruvideoSdk.xcframework.zip",
            checksum: "098a92dbd5da1d7b34e1fa3b76a5046a00baed0ab7c42225911c75cdd01cf912"
        ),
        .binaryTarget(
            name: "Common",
