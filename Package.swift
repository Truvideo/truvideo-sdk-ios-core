...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.2-RC.125/TruvideoSdk.xcframework.zip",
            checksum: "c4ccc9ac86c8a13f3fe081423a604a5a7c693411200733bc72b808a507548562"
        ),
        .binaryTarget(
            name: "Common",
