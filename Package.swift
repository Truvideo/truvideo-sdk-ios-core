...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.3-DEV.159/TruvideoSdk.xcframework.zip",
            checksum: "1f9ccfd1471d76e34e27daca1fd26a4cdc1ffcfb292d9e925bfaf7c83b25ff1a"
        ),
        .binaryTarget(
            name: "Common",
