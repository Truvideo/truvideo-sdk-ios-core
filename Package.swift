...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.1-DEV.149/TruvideoSdk.xcframework.zip",
            checksum: "c4d25b35b4d46089dc82af46366a8de1d5f80c4838aab81574fe7e55af7c5db7"
        ),
        .binaryTarget(
            name: "Common",
