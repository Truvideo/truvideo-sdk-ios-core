...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.3-BETA.158/TruvideoSdk.xcframework.zip",
            checksum: "26d64158c7fbf5e2e2709f63bd97c6e4dc5ddf3c4fbd349a71474c7a880205db"
        ),
        .binaryTarget(
            name: "Common",
