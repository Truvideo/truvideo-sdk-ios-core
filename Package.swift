...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.2-DEV.126/TruvideoSdk.xcframework.zip",
            checksum: "537e3f31c6129dea59f57665adec39fdf9fe57667d947090ebd31b1834f29b12"
        ),
        .binaryTarget(
            name: "Common",
