...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.3-DEV.157/TruvideoSdk.xcframework.zip",
            checksum: "917bd47a4ccd567043d8bff5417d89e278bde4034f5120947d6cba47631f7936"
        ),
        .binaryTarget(
            name: "Common",
