...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-BETA.233/TruvideoSdk.xcframework.zip",
            checksum: "a0aa6dcd3eb3c8bfcc4f48ac6f9c3d5a66de40636ba5c9047b783671f238b6b9"
        ),
        .binaryTarget(
            name: "Common",
