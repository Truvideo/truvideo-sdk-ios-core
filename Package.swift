...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.1.3-RC.156/TruvideoSdk.xcframework.zip",
            checksum: "0dfc460145b8d0d5c509f4b1665c19d526b0aece8475240b6942d78b48ecf482"
        ),
        .binaryTarget(
            name: "Common",
