...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-BETA.232/TruvideoSdk.xcframework.zip",
            checksum: "1537011974bdc0038345b3deb52c3c091ad1ce8e44c184be02e1a297cde8dd98"
        ),
        .binaryTarget(
            name: "Common",
