...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/0.0.35/TruvideoSdk.xcframework.zip",
            checksum: "015d5792258429a078231f6df8bab94037630c54ac6811ae98e7ffced5cd6f7b"
        ),
        .binaryTarget(
            name: "Common",
