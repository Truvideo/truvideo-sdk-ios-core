...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.2-RC.130/TruvideoSdk.xcframework.zip",
            checksum: "fa91f5b8b48a1d50e9db99f0ddb1c035e58e0ad988dd0f122ff94987c163696c"
        ),
        .binaryTarget(
            name: "Common",
