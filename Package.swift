...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/0.1.2-beta.89/TruvideoSdk.xcframework.zip",
            checksum: "fcf751f840641a42a264c83af9a6590552b2fff17a98a84725258148446c8042"
        ),
        .binaryTarget(
            name: "Common",
