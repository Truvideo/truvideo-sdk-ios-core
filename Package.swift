...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.221/TruvideoSdk.xcframework.zip",
            checksum: "2c163596b0f847352b71b0899fb18f46233829593f1fbe31f2bc28be7251e473"
        ),
        .binaryTarget(
            name: "Common",
