...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-BETA.231/TruvideoSdk.xcframework.zip",
            checksum: "bcb2d2af05ecec1e4b7a36e2bd4669b709e7f32217f531fe3ac89eac6007c7b4"
        ),
        .binaryTarget(
            name: "Common",
