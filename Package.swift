...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/0.1.2.87-beta/TruvideoSdk.xcframework.zip",
            checksum: "b9bec01999da42299f3e1ca069077abf48aa13949c75bb5061388624c9e8d018"
        ),
        .binaryTarget(
            name: "Common",
