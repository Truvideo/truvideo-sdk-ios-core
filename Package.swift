...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.213/TruvideoSdk.xcframework.zip",
            checksum: "7f459453fe84cf2f83d7add6d79009f2c108c7bd5b50a0c1eb81bc3ee69cf16b"
        ),
        .binaryTarget(
            name: "Common",
