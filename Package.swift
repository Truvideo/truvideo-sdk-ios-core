...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/73.1.1-DEV.105/TruvideoSdk.xcframework.zip",
            checksum: "3d3c777d91cab572ac83f1aaa137a85345f99fb2488e595efb801e0df93e25ae"
        ),
        .binaryTarget(
            name: "Common",
