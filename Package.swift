...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/78.1.1-RC.226/TruvideoSdk.xcframework.zip",
            checksum: "8e3b1b354f2eb66b530b9664cc8155cef1cf8280f88d6622a4be8d1c4d4768e4"
        ),
        .binaryTarget(
            name: "Common",
