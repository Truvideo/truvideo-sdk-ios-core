...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/0.0.38/TruvideoSdk.xcframework.zip",
            checksum: "0d85ef8ca26b045464a9a15266d824891580ffa166d0e8abbab3bae17229a895"
        ),
        .binaryTarget(
            name: "Common",
