...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/76.2.1-DEV.222/TruvideoSdk.xcframework.zip",
            checksum: "954978649bf8cb56f02091dce6ff3573f3c87b3a2e7495411a2ed9e068530fe4"
        ),
        .binaryTarget(
            name: "Common",
