...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-core/releases/download/0.1.00-beta/TruvideoSdk.xcframework.zip",
            checksum: "67b2d822c93596cf5762e0a999c0bd0b682c9dafc5f20a76c194dd5e8738471b"
        ),
        .binaryTarget(
            name: "Common",
